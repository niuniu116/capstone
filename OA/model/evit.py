...
default_cfgs = {
    ...
    'deit_small_patch2_28_shrink':_cfg(
        mean=IMAGENET_DEFAULT_MEAN, std=IMAGENET_DEFAULT_STD,
        input_size=(256, 28, 28)),
    'deit_small_patch1_7_shrink': _cfg(
        mean=IMAGENET_DEFAULT_MEAN, std=IMAGENET_DEFAULT_STD,
        input_size=(512, 7, 7)),
...
class EViT(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 act_layer=None, weight_init='', keep_rate=(1, ), fuse_token=False, default_cfg=None, **kwargs):
        """
        Args:
...
@register_model
def deit_small_patch2_28_shrink(pretrained=False, **kwargs):
    """

    """
    model_kwargs = dict(patch_size=2, embed_dim=768, depth=12, num_heads=12, **kwargs)
    model = _create_evit('deit_small_patch2_28_shrink', pretrained=pretrained, **model_kwargs)
    return model

@register_model
def deit_small_patch1_7_shrink(pretrained=False, **kwargs):
    """

    """
    model_kwargs = dict(patch_size=1, embed_dim=768, depth=12, num_heads=12, **kwargs)
    model = _create_evit('deit_small_patch1_7_shrink', pretrained=pretrained, **model_kwargs)
    return model
